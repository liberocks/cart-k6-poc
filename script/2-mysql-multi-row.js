...
let script = "INSERT INTO cart (market_id,pharmacy_id,items,created_at,updated_at,deleted_at) VALUES";

for (let i = 0; i < ITEM_COUNT; i++) {
  if (i !== ITEM_COUNT - 1) {
    script += `\n('abc',1,'${generatePayload(1)}','2021-04-29 00:00:00.0','2021-04-29 01:23:45.0',NULL),`;
  } else {
    script += `\n('abc',1,'${generatePayload(1)}','2021-04-29 00:00:00.0','2021-04-29 01:23:45.0',NULL);`;
  }
}
